...
class GymNutritionController extends AppController
{
    ...
    public function addNutritionSchedule()
    {
        ...
        if ($this->request->is("post")) {
            ...
            if(!array_key_exists('activity_list',$data)){
                $this->Flash->error(__("Error! Fill enough Data."));
    ...
    public function nutrition_detail($nutrition_id, $activity_list)
    {
        ...
        foreach ($ma_row as $m_row) {
            ...
            $this->GymNutrition->GymNutritionData->save($m_row);
        }
        ...
        switch ($role_name) {
            CASE "member":
                if (in_array($curr_action, $members_actions)) {
                    ...
                    return $this->redirect(["action" => "memberNutrition"]);
                }
